...
public sealed partial class ModsuitSystem
{
    ...
    private void OnRemoveModuleBuiMessage(Entity<ModsuitComponent> ent, ref BorgRemoveModuleBuiMessage args)
    {
        ...
        _adminLog.Add(LogType.Action, LogImpact.Medium,
            $"{ToPrettyString(args.Actor):player} removed module {ToPrettyString(module)} from borg {ToPrettyString(ent)}");
    ...
    public void UpdateUI(EntityUid uid, ModsuitComponent? component = null)
    {
